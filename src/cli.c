...
const clivalue_t valueTable[] = {
    ...
    { "rg_1_dest", VAR_UINT8, &mcfg.remote_gain_settings[0].dest, 0, (3 * PIDITEMS) - 1 },
    ...
    { "rg_2_dest", VAR_UINT8, &mcfg.remote_gain_settings[1].dest, 0, (3 * PIDITEMS) - 1 },
    ...
    { "rg_3_dest", VAR_UINT8, &mcfg.remote_gain_settings[2].dest, 0, (3 * PIDITEMS) - 1 },
    ...
    { "rg_4_dest", VAR_UINT8, &mcfg.remote_gain_settings[3].dest, 0, (3 * PIDITEMS) - 1 },
};
